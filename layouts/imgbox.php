...
function print_social_zone($all_opt, $social_display_icon) {
    if (iro_opt('wechat')): ?>
    ...
    <div class="homepage-widget">
        ...
        <div class="homepage-widget-card">
            ...
            <?php elseif ($author_info['type'] == 'double'): ?>
                <div class="hwcard-content">
                    <?php foreach ($author_info['authors'] as $author_data): ?>
                        <div class="hwcard-author-d">
                        <div class="hwcard-author-d-e1">
                            <div class="hwcard-author-avatar-d">
                                <a href="<?= get_author_posts_url($author_data['author']->ID); ?>">
                                    <?= get_avatar($author_data['author']->ID, 40); ?>
                                </a>
                            </div>
                            <div class="hwcard-author-data-d">
                                <a href="<?= get_author_posts_url($author_data['author']->ID); ?>">
                                    <span class="hwcard-author-name-d"><?= esc_html($author_data['author']->display_name); ?></span>
                                </a>
                                <span class="hwcard-author-desc-d">
                                    <?= esc_html(mb_strlen($author_data['author_description'], 'UTF-8') > 15 ? mb_substr($author_data['author_description'], 0, 15, 'UTF-8') . '...' : $author_data['author_description']); ?>
                                </span>
                            </div>
                            </div>
                            <div class="hwcard-author-data-item-d">
                                <i class="fa-regular fa-pen-to-square" style="font-size: 12px;"></i>
                                <span class="hwcard-author-data-value-d"><?= count_user_posts($author_data['author']->ID); ?></span>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
        ...
        <div class="homepage-widget-card">
            ...
            <div class="hwcard-content">
                <div class="hwcard-socialnet">
                    <?php print_social_zone($all_opt, $social_display_icon); ?>
                </div>
            </div>
        </div>
    </div>
